...
siakad=# insert into mahasiswa (nim,nama,prodi) values ('D0221333','Ramdhani','informatika'),('D0221322','Alnesta','informatika'),('D0221311','Taufik','informatika');
INSERT 0 3
siakad=# select * from mahasiswa;
   nim    |      nama      |    prodi
----------+----------------+-------------
 D0221333 | Ramdhani       | informatika
 D0221322 | Alnesta        | informatika
 D0221311 | Taufik         | informatika
(3 rows)
...
siakad=# insert into kuliah (kode_makul,nama_makul,sks,semeter) values ('INF183219','pemprograman web I',2,3),('INF173319','Aljabar Linear',3,3),('INF123319','Basis Data I',2,3);
INSERT 0 3
siakad=# select * from kuliah;
 kode_makul |       nama_makul        | sks | semeter
------------+-------------------------+-----+---------
 INF183219  | pemprograman web I      |   2 |       3
 INF173319  | Alajabar Linear         |   3 |       3
...
siakad=# update mahasiswa set nama='alnesta' where nim = 'D0221322';
UPDATE 1
siakad=# select * from mahasiswa;
   nim    |      nama      |    prodi
----------+----------------+-------------
